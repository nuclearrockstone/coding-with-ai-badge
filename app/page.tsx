...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6 sm:py-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0">
              <h1 className="truncate text-base font-bold text-foreground sm:text-lg">{messages.common.title}</h1>
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <a
              ...
              className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-lg bg-secondary text-sm font-medium text-secondary-foreground transition-colors hover:bg-secondary/80 sm:h-auto sm:w-auto sm:gap-2 sm:px-4 sm:py-2"
            >
      ...
      {/* Hero Section */}
      <section className="border-b border-border bg-gradient-to-b from-muted/50 to-transparent py-10 sm:py-16">
        <div className="mx-auto max-w-6xl px-4 text-center sm:px-6">
          <h2 className="mb-3 text-2xl font-bold tracking-tight text-foreground sm:mb-4 sm:text-4xl md:text-5xl">
            {messages.hero.title}
          </h2>
