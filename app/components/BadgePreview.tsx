    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="flex items-center justify-center rounded-xl bg-white p-8 shadow-lg ring-1 ring-slate-200">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="flex items-center justify-center rounded-xl bg-slate-900 p-8 shadow-lg ring-1 ring-slate-700">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src={svgUrl}
