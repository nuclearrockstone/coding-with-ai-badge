    ...
    <div className="flex flex-col gap-4 sm:gap-6">
      ...
      <div className="flex flex-col items-center gap-6 sm:gap-8">
        ...
        <div className="flex w-full flex-col items-center gap-2 sm:gap-3">
          ...
          <div className="flex w-full items-center justify-center overflow-x-auto rounded-lg bg-white p-4 shadow-lg ring-1 ring-slate-200 sm:rounded-xl sm:p-8">
        ...
        <div className="flex w-full flex-col items-center gap-2 sm:gap-3">
          ...
          <div className="flex w-full items-center justify-center overflow-x-auto rounded-lg bg-slate-900 p-4 shadow-lg ring-1 ring-slate-700 sm:rounded-xl sm:p-8">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src={svgUrl}
