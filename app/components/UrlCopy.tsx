      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            ...
            className="flex h-9 shrink-0 cursor-pointer items-center gap-1.5 rounded-md bg-secondary px-3 text-xs font-medium text-secondary-foreground transition-colors hover:bg-secondary/80 active:scale-95"
          >
            {copiedType === 'url' ? (
              <>
                ...
                <span className="hidden xs:inline">{t.copied}</span>
              </>
            ) : (
              <>
                ...
                <span className="hidden xs:inline">{t.copy}</span>
              </>
            )}
          </button>
        </div>
