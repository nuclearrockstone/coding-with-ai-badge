      ...
      <div className="flex flex-col gap-3 sm:gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Popover open={categoryOpen} onOpenChange={setCategoryOpen}>
            ...
            <PopoverContent className="max-w-[calc(100vw-2rem)] p-0 sm:w-full" align="start">
              <Command>
      ...
      <div className="flex flex-col gap-3 sm:gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="min-h-[44px] rounded-lg border border-input bg-background px-4 py-2.5 text-sm text-foreground placeholder-muted-foreground transition-colors focus:border-ring focus:outline-none focus:ring-2 focus:ring-ring/20 sm:min-h-0"
          />
        </div>
      ...
      <div className="flex flex-col gap-3 sm:gap-4">
        ...
        <div className="flex gap-2 sm:gap-3">
          <Button
            ...
            className="min-h-[44px] flex-1 cursor-pointer sm:min-h-0"
          >
